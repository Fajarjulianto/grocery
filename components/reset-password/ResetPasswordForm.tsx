...
/**
 * A client component that handles the password reset logic and form interaction.
 * It uses useSearchParams, which requires it to be wrapped in a <Suspense> boundary.
 *
 * @returns {JSX.Element} The rendered password reset form.
 */
// The function name is changed from Page to ResetPasswordForm
