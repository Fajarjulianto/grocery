...
const sortOptions = ['Relevance', 'Popularity', 'Price: Low to High', 'Price: High to Low'];

export default function HomeView({ initialProducts, staticCategories }: HomeViewProps) {
